...
class UserPhoneNumberChangeForm(forms.ModelForm):
    ...
    phone_number = forms.CharField(validators=[phone_regex], label='Phone Number', max_length=10, required=False)
    class Meta:
        model = User
        fields = ( 'phone_number',)
...
class GuestForm(forms.ModelForm):
    ...
    def __init__(self, request, *args, **kwargs):
        ...
        self.fields['phone_number'].widget.attrs.update({'class': 'form-control', 'id': 'phone_number', 'placeholder': 'Phone Number'})
...
class LoginForm(forms.Form):
    ...
    email = forms.EmailField(label='Email', widget=forms.EmailInput(attrs={'class': 'form-control', 'id': 'email', 'placeholder': 'Email'}))
...
class RegisterForm(forms.ModelForm):
    ...
    password1 = forms.CharField(label='Password', widget=forms.PasswordInput(attrs={'class': 'form-control', 'id': 'password', 'placeholder': 'Password'}))
    password2 = forms.CharField(label='confirm Password', widget=forms.PasswordInput(attrs={'class': 'form-control', 'id': 'conf_password', 'placeholder': 'Confirm Password'}))
    ...
    def save(self, commit=True):
        ...
        user.set_password(self.cleaned_data["password1"])
        user.is_active = False # send conformation email via signals
